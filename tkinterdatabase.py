# Import library untuk membuat database
import sqlite3
# Import tkinter
...
# Membuat button untuk submit, update, dan delete
...
# Kolom yang akan ditampilkan pada tabel ditentukan
columns = ('id', 'nama_siswa', 'biologi', 'fisika', 'inggris', 'prediksi_fakultas')

# Membuat elemen Treeview untuk menampilkan data dalam bentuk tabel di GUI
tree = ttk.Treeview(root, columns=columns, show='headings')

# Loop untuk mengatur heading (judul kolom) dan properti kolom pada tabel
for col in columns:
    tree.heading(col, text=col.capitalize())
    tree.column(col, anchor='center')

# Menempatkan elemen Treeview di grid layout pada jendela aplikasi (baris ke-5, kolom ke-0)
tree.grid(row=5, column=0, columnspan=3, padx=10, pady=10)

# Menambahkan event binding pada elemen Treeview untuk memanggil fungsi 'fill_inputs_from_table' saat pengguna mengklik sebuah baris pada tabel
...
# Memulai loop utama Tkinter untuk menjalankan aplikasi GUI
root.mainloop()
